...
const DEMO_PATIENTS = [
  ...
  { label: 'Medium risk', payload: { patient_id: 'DEMO-002', age: 70, gender: 'female' as const, institution_id: 'ukhd', conditions: ['hypertension', 'type2_diabetes', 'obesity'], medications: ['metformin', 'losartan'], recent_encounters: 2 } },
